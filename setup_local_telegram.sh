...
echo "Я обновил nwscan.py, теперь вам не нужно менять код вручную."
echo "Просто укажите новый адрес в nwscan_config.json:"
echo "  \"telegram_api_url\": \"http://localhost:$PORT\""
echo "Или задайте переменную окружения TELEGRAM_API_BASE_URL."
echo "=========================================================================="
